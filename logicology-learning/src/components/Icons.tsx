...
export const LogicologyLogo = ({ className = "w-8 h-8" }: IconProps) => (
  <div className={`${className} bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center shadow-lg`}>
